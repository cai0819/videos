        ...
        <div class="container">
            <span>欢迎来到Y先生教育！</span>
	            ...
	            <div id="userBlock" style="display:none;float:right">
	               ...
	               <a href="my_profile.jsp" id="account"></a>
	            </div>
        ...
        <div class="container">
            ...
            <div class="course-info">
                <table cellspacing="10">
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/subject/listAllAndCourse?subjectId=1">
                        ...
                        <td>
                            <!--上线时修改id-->
                            <a href="${pageContext.request.contextPath}/subject/listAllAndCourse?subjectId=6">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/subject/listAllAndCourse?subjectId=10">
                    ...
                    <tr>
                        <td colspan="2">
                            <a href="${pageContext.request.contextPath}/subject/listAllAndCourse?subjectId=11">
        ...
        <div class="mask_content">
            ...
            <div class="mask_content_body">
                <form id="loginForm" action="#">
                    ...
                    <div id="forget">
                        <a href="${pageContext.request.contextPath}/forget_password.jsp">忘记密码？</a>
                    </div>
