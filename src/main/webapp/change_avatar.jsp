    ...
    <div class="container">
        ...
        <div id="profile_tab">
            ...
            <div class="proflle_tab_body">
                <h3><a href="/my_Profile.html">返回个人中心</a></h3>
                <div class="proflle_tab_workplace clearfix">
                    <div class="profile_avatar_area">
                        ...
                        <c:if test="${not empty userLogin.imgUrl}">
                            <img width="200px" height="200px" src="${userLogin.imgUrl}">
                        </c:if>
                    ...
                    <div class="profile_ifo_area">
                        <form id="upload_form" enctype="multipart/form-data" method="post"
                              action="${pageContext.request.contextPath}/user/upLoadImage.do">
                            <!-- hidden crop params -->
                            ...
                            <p>第一步：请选择图像文件</p>
                            <div><input type="file" name="imgUrl" id="image_file" onchange="fileSelectHandler()"/></div>
