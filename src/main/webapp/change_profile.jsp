...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function(){
           ...
           var address ='${userLogin.address}'; //""  河南-平顶山
                ...
                <div class="proflle_tab_body">
                    ...
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <img width="180px" height="180px"  src="${userLogin.imgUrl}">
                        </div>
                        <div class="profile_ifo_area">
                            <!--http://localhost/video/user/changeProfile-->
                            <form action="/QFVideos/user/updateUser.do" method="post">
                                <input name="id" type="hidden" value="${userLogin.id}">
                                <div class="form_group">
                                    <span class="dd">昵&#x3000;称：</span><input type="text" name="nickName" value="${userLogin.nickName}" >
                                </div>
                                <div class="form_group">
                                ...
                                <div class="form_group">
                                    ...
                                    <input type="text"  name="birthday" value="${userLogin.birthday}">
                                </div>
                                <div class="form_group">
